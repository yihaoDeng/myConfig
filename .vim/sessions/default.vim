...
" Vim session script.
" Created by session.vim 2.7 on 22 一月 2015 at 00:49:21.
...
set shortmess=aoO
badd +1 check_chassis_log.c
badd +1 -MiniBufExplorer-
badd +1 check_chassis_path.c
badd +7 check_sql_tokenizer.c
badd +1 t_network_queue.c
argglobal
silent! argdel *
argadd check_chassis_log.c
edit check_chassis_log.c
